...
<%  
    ...
    try {
        ...
        if (orderQuantity == 0) {
            String message = "❌ 訂單數量不可為0！";
            String newUrl = buildOrderUrl("../jsp/edit_order.jsp", message, isClosed, orderDueDate, 
            ...
            return;
        } else if (orderQuantity - shippedQuantity < 0) {
            String message = "❌ 已出貨量不可大於訂單數量！";
            String newUrl = buildOrderUrl("../jsp/edit_order.jsp", message, isClosed, orderDueDate, 
                    clientId, t2tOrderNo, tBoxOrderNo, 
                    tSourceOrderNo, t2cDueDate, t2cOrderNo, 
                    mailSentDate, scheduleSuggestion, clientOrderNo, 
        ...
        if (!resultSet.next()) {
            String message = "❌ 客戶代號 " + clientId + " 不存在！";
            String newUrl = buildOrderUrl("../jsp/edit_order.jsp", message, isClosed, orderDueDate, 
                    clientId, t2tOrderNo, tBoxOrderNo, 
                    tSourceOrderNo, t2cDueDate, t2cOrderNo, 
                    mailSentDate, scheduleSuggestion, clientOrderNo, 
        ...
        preparedStatement.setString(4, t2tOrderNo);
        preparedStatement.setString(5, tBoxOrderNo);
        preparedStatement.setString(6, tSourceOrderNo);
        preparedStatement.setDate(7, java.sql.Date.valueOf(t2cDueDate));
        preparedStatement.setDate(8, java.sql.Date.valueOf(mailSentDate));
        preparedStatement.setString(9, scheduleSuggestion);
        preparedStatement.setString(10, clientOrderNo);
        preparedStatement.setString(11, purchaseOrderNo);
        preparedStatement.setString(12, productionOrderNo);
        preparedStatement.setString(13, outsourcingOrderNo);
        preparedStatement.setInt(14, orderQuantity);
        preparedStatement.setInt(15, shippedQuantity);
        preparedStatement.setString(16, note);
        preparedStatement.setString(17, t2cOrderNo);

        // 3. 執行
        preparedStatement.executeUpdate();

        response.sendRedirect(buildOrderUrl("../jsp/show_orders.jsp", "⭕ 更新成功！"));
    } catch (Exception e) {
