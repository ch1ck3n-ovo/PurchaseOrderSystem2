...
<%
    ...
    try {
        ...
        response.sendRedirect(buildRedirectUrl("../jsp/show_clients.jsp", "⭕ 更新成功！"));

    } catch (Exception e) {

        String message = "❌ 錯誤： " + e.getMessage().replace("'", "\\'");
        response.sendRedirect(buildRedirectUrl("../jsp/edit_client.jsp", message, clientId, clientName));
    } finally {
