...
<%
    ...
    String buttonAdd    = next.equals("add_order.jsp")      ? "button--selected" : "";
    String buttonShow   = next.equals("show_orders.jsp")    ? "button--selected" : "";
...
<html>
    ...
    <body>
        <div id="navbar--fixed">
            ...
            <a class="button <%= buttonAdd %>" href="select_client.jsp?next=add_order.jsp">
                <img class="svg" src="../assets/img/clipboard-plus.svg"/>
                新增訂單
            </a>
            <a class="button <%= buttonShow %>" href="select_client.jsp?next=show_orders.jsp">
                                ...
                                <tr class="client-table__row client-table__row--scale">
                                    ...
                                    <th class="client-table__cell client-table__cell--actions">
                                        <div class="client-table__actions">
                                            <a class="button" href="<%= next %>?client_id=<%= clientId %>&client_name=<%= clientName %>">選擇</a>
                                        </div>
                                    </th>
                                </tr>
                    <%
