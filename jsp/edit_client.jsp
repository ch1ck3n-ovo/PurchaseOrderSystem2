...
<html>
    <head>
        ...
        <link rel="icon" href="../assets/img/user-pen.svg" type="image/svg+xml" />
    </head>
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form action="../sql/update_client.jsp" method="post">
                <div class="form-field">
                    <div class="form-label">客戶代號</div>
                    <input class="input input--text" type="text" name="client_id" value="<%= clientId %>" maxlength="20" 
                            oninput="this.value = this.value.replace(/[^a-zA-Z0-9\-]/g, '')" required readonly>
                </div>
                <div class="form-field">
                    <div class="form-label">客戶名稱</div>
                    <input class="input input--text" type="text" name="client_name" value="<%= clientName %>" maxlength="20" required>
                </div>
